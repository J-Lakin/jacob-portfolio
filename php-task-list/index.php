...
// Jacob Lakin
// 11/15/2023
// Modified to sort the stored tasks within the array. Modified the promote, modified, and sort buttons to work correctly.
...
switch( $action ) {
    ...
    case 'Promote Task':
        ...
        if ($task_index === NULL || $task_index === FALSE) {
            ...
            $errors[] = 'Your can\'t premote the first task.';
        } else {
