...
// Jacob Lakin
// 11/15/2023
// Modified the sort tasks button to work correctly.
-->
...
<body>
    ...
    <main>
        ...
        <form action="." method="post" >
            ...
            <?php if (count($task_list)> 1 && empty($task_to_modify)) : ?> <!-- do not display the sort buttion if stack has only one element -->
            <br><br>
            <label>&nbsp;</label>
